...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(427.0, -806.15, 29.49, 103.41),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        type = "clothing",
        coords = vector4(-1791.69, -1168.55, 13.2, 312.33),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        type = "clothing",
        coords = vector4(175.11, -908.1, 29.63, 61.58),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(169.49, -905.28, 29.63),
            vector3(170.21, -903.89, 29.63),
            vector3(170.51, -902.46, 29.63),
            vector3(171.15, -901.11, 29.63)
        }
    },
    {
        type = "barber",
    ...
    {
        type = "barber",
        coords = vector4(-1762.09, -1135.03, 13.2, 323.02),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        type = "tattoo",
        coords = vector4(-1776.58, -1152.11, 13.2, 322.34),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
